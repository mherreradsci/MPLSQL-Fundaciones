CREATE OR REPLACE PACKAGE tifund_own.grl_defs
/*
* Empresa:    Explora Information Technologies
* Proyecto:   Definiciones generales
* Objetivo:   Package de definiciones generales para proyectos PL/SQL
*
* Historia    Quien    Descripcion
* ----------- -------- ---------------------------------------------------------
* 02-Dic-2004 mherrera Creacion
* 15-Jul-2024 mherrera Include conditional compilation for DBMS_DB_VERSION
*/

IS
    -- Subtipos para identificar packages y Programas, usado por UTL_ERROR
    -- o UTL_LOG_PROCESOS
