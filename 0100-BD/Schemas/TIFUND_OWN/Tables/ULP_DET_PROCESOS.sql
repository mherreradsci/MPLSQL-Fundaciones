-- * Table: TIFUND_OWN.ULP_DET_PROCESOS
CREATE TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" 
   (
    "PROC_ID" NUMBER(10,0), 
    "SECUENCIA" NUMBER(8,0), 
    "NOMBRE_MODULO" VARCHAR2(65), 
    "TIPO_MENSAJE" VARCHAR2(3), 
...
--   12 Comments found.
-- * Constraint Indexes:
-- ** Constraint Indexes: TIFUND_OWN.ULP_DET_PROCESOS
CREATE UNIQUE INDEX "TIFUND_OWN"."DEPR_PK" ON "TIFUND_OWN"."ULP_DET_PROCESOS" ("PROC_ID", "SECUENCIA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "INDX" 
/
--    1 Constraint indexes found.
-- * Constraints: TIFUND_OWN.ULP_DET_PROCESOS
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("PROC_ID" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("SECUENCIA" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("NOMBRE_MODULO" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("TIPO_MENSAJE" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("AUD_CREADO_EL" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" MODIFY ("AUD_CREADO_POR" NOT NULL ENABLE)
/
...
ALTER TABLE "TIFUND_OWN"."ULP_DET_PROCESOS" ADD CONSTRAINT "DEPR_PK" PRIMARY KEY ("PROC_ID", "SECUENCIA")
  USING INDEX "TIFUND_OWN"."DEPR_PK"  ENABLE;
--    8 Constraints found.
