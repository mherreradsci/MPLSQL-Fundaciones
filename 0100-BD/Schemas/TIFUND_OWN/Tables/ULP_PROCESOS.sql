...
--   15 Comments found.
-- * Constraint Indexes:
-- ** Constraint Indexes: TIFUND_OWN.ULP_PROCESOS
CREATE UNIQUE INDEX "TIFUND_OWN"."PROC_PK" ON "TIFUND_OWN"."ULP_PROCESOS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "INDX" 
/
--    1 Constraint indexes found.
-- * Constraints: TIFUND_OWN.ULP_PROCESOS
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("ID" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("SIST_ID_SISTEMA" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("NOMBRE_PROCESO" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("FECHA_INICIO" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("ESTADO" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("AUD_CREADO_EL" NOT NULL ENABLE)
/
ALTER TABLE "TIFUND_OWN"."ULP_PROCESOS" MODIFY ("AUD_CREADO_POR" NOT NULL ENABLE)
/
